...
- Feature adds plugin runtime or menu pieces → revisit `.cursor/rules/plugin-system.md`, `frontend/apps/web-antd/src/stores/plugin-slots.ts`.

## How to Work the Guides

1. Pick the relevant guide from this directory.
2. Read the referenced `.cursor/rules/*.md` plus the real files that exemplify the contract.
