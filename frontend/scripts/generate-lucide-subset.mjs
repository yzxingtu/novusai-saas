...
const BARE_ICON_RULES = [
  {
    file: resolve(
      REPO_ROOT,
      'backend/plugins/weather-widget/frontend/src/weather-codes.ts',
    ),
...
function main() {
  ...
  const requestedIconNames = [...iconNames].toSorted((left, right) =>
    left.localeCompare(right),
  );
  ...
  if (missingNames.length > 0) {
    throw new Error(`Unknown lucide icon names: ${missingNames.join(', ')}`);
  }

  const subsetOutput = `// Generated by frontend/scripts/generate-lucide-subset.mjs / 脚本生成
...
`;
  ...
  const catalogOutput = `// Generated by frontend/scripts/generate-lucide-subset.mjs / 脚本生成
// Do not edit manually. / 请勿手改
