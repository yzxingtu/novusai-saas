...
This directory is the NovusAI frontend workspace. It is based on Vben Admin, but the product app in this repository is `apps/web-antd`, not the upstream playground.
