...
<template>
  ...
  >
          ...
          <div class="flex items-start gap-4">
            ...
            <div>
              <div class="text-sm font-medium text-white/90">
                {{ $t('user.auth.featureAI') }}
              </div>
              <div class="mt-0.5 text-xs text-white/40">
                {{ $t('user.auth.featureAIDesc') }}
              </div>
            </div>
          </div>
          <div class="flex items-start gap-4">
            <div
              class="flex size-10 shrink-0 items-center justify-center rounded-xl bg-primary/20"
            >
              <IconifyIcon icon="lucide:file-text" class="text-lg text-primary" />
            </div>
            <div>
              <div class="text-sm font-medium text-white/90">
                {{ $t('user.auth.featureKnowledge') }}
              </div>
              <div class="mt-0.5 text-xs text-white/40">
                {{ $t('user.auth.featureKnowledgeDesc') }}
              </div>
            </div>
          </div>
          <div class="flex items-start gap-4">
            <div
              class="flex size-10 shrink-0 items-center justify-center rounded-xl bg-primary/20"
            >
              <IconifyIcon icon="lucide:shield-check" class="text-lg text-primary" />
            </div>
            <div>
              <div class="text-sm font-medium text-white/90">
                {{ $t('user.auth.featureSecurity') }}
              </div>
              <div class="mt-0.5 text-xs text-white/40">
                {{ $t('user.auth.featureSecurityDesc') }}
              </div>
            </div>
          </div>
        </div>
    ...
    <!-- Right: Form Panel -->
    <div
      class="user-form-panel relative flex flex-1 flex-col items-center justify-center px-6 lg:px-12"
    >
      <!-- Mobile logo -->
