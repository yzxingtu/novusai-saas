...
export enum ErrorCode {
  ...
  NOT_FOUND = 4040,
  /** 原密码不正确 / Original password incorrect */
  OLD_PASSWORD_INCORRECT = 4004,
  /** 权限不足 / Permission denied */
  PERMISSION_DENIED = 4031,
  /** 该节点不允许添加成员 / Node does not allow adding members */
  ROLE_CANNOT_ADD_MEMBER = 4110,
  // ============================================================
  // ---- Role related / 角色相关 ---- (41xx)
  // ============================================================
  /** 不能将自己设为父节点 / Cannot set self as parent node */
  ROLE_CANNOT_SET_SELF_AS_PARENT = 4101,
  /** 检测到循环引用 / Circular reference detected */
  ROLE_CIRCULAR_REFERENCE = 4102,
  /** 该节点下有子节点，无法删除 / Node has child nodes, cannot delete */
  ROLE_HAS_CHILDREN = 4106,
  /** 该角色下有用户，无法删除 / Role has users, cannot delete */
  ROLE_HAS_USERS = 4107,
  /** 不允许的子节点类型 / Disallowed child node type */
  ROLE_INVALID_CHILD_TYPE = 4108,
  /** 超过最大层级深度限制 / Exceeded maximum depth limit */
  ROLE_MAX_DEPTH_EXCEEDED = 4103,
  /** 该成员已在此节点 / Member already exists in this node */
  ROLE_MEMBER_EXISTS = 4111,
  /** 该成员不在此节点 / Member does not exist in this node */
  ROLE_MEMBER_NOT_IN_NODE = 4112,

  /** 只有部门类型可以设置负责人 / Only department type can set leader */
  ROLE_ONLY_DEPARTMENT_CAN_SET_LEADER = 4109,
  /** 系统角色不能修改父级 / System role cannot change parent */
  ROLE_SYSTEM_CANNOT_CHANGE_PARENT = 4104,
  /** 系统角色不能删除 / System role cannot delete */
