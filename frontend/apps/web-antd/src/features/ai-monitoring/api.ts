...
export interface MonitoringConversationInfo {
  ...
  latest_conversation_outcome?: null | string;
  latest_error_message?: null | string;
  latest_failure_kind?: null | string;
  latest_termination_reason?: null | string;
  latest_turn_created_at?: null | string;
  latest_turn_error_type?: null | string;
  latest_turn_flow_terminal_status?: null | string;
  latest_turn_flow_terminal_type?: null | string;
  latest_turn_outcome?: null | string;
  latest_turn_status?: null | string;
  lifecycle_status?: null | string;
  message_count: number;
  owner_type?: null | string;
  display_status?: null | string;
  status: string;
  tenant_id?: null | number;
  tenant_name?: null | string;
  title: null | string;
