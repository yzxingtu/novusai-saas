...
export function previewCrudGenerateApi(config: object) {
  return requestClient.post<PreviewResponse>('/plugins/crud-generator/crud/preview', {
    config,
...
export function generateCrudApi(
  ...
  return requestClient.post<GenerateResult>('/plugins/crud-generator/crud/generate', {
    config,
...
export function previewCrudDdlApi(config: object) {
  return requestClient.post<{ sql: string }>('/plugins/crud-generator/crud/ddl', config);
}
