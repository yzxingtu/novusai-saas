/**
 * CRUD 代码生成记录 API
 * 对接后端 /plugins/crud-generator/crud/records 接口
 */
...
export function getCrudRecordListApi(params?: Record<string, unknown>) {
  return requestClient.get<{ items: CrudRecordInfo[]; total: number }>(
    '/plugins/crud-generator/crud/records',
    { params },
  );
}
...
export function getCrudRecordDetailApi(id: number) {
  return requestClient.get<CrudRecordDetail>(
    `/plugins/crud-generator/crud/records/${id}`,
  );
}

/** 获取记录配置快照 */
export function getCrudRecordConfigApi<T = Record<string, unknown>>(id: number) {
  return requestClient.get<T | null>(
    `/plugins/crud-generator/crud/records/${id}/config`,
  );
}
...
export function getCrudRecordStatisticsApi() {
  return requestClient.get<CrudRecordStatistics>(
    '/plugins/crud-generator/crud/records/statistics',
  );
}

/** 删除记录 */
export function deleteCrudRecordApi(id: number) {
  return requestClient.delete(`/plugins/crud-generator/crud/records/${id}`);
}
...
export function deleteGeneratedFilesApi(body: {
  ...
  return requestClient.post<DeleteFilesPreview | DeleteFilesResult>(
    '/plugins/crud-generator/crud/records/delete-files',
    body,
  );
}
...
export function rollbackGenerationApi(body: {
  ...
  return requestClient.post<DeleteFilesResult>(
    '/plugins/crud-generator/crud/records/rollback',
    body,
  );
}
