...
export interface RoleCreateRequest {
  ...
  /** Data scope: all/dept_children/dept_only/self/custom / 数据范围 */
  data_scope?: DataScopeType;
  /** Custom department IDs (when data_scope=custom) / 自定义部门 ID 列表 */
...
export interface RoleUpdateRequest {
  ...
  /** Data scope / 数据范围 */
  data_scope?: null | DataScopeType;
  /** Custom department IDs / 自定义部门 ID 列表 */
  custom_dept_ids?: null | number[];
}
