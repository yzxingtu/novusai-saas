/**
 * Tenant management API / 租户管理 API
...
/** Tenant list query params / 租户列表查询参数 */
export type TenantListParams = Record<string, unknown>;

/** Create tenant request / 创建租户请求 */
export interface TenantCreateRequest {
  /** Tenant code (optional, auto-generated by backend) / 租户编码 */
  code?: string;
  name: string;
...
/** Tenant info (backend raw snake_case) / 租户信息（后端原始格式） */
...
/** Tenant info (frontend camelCase) / 租户信息（前端格式） */
...
/** Tenant select option result / 租户下拉选项结果 */
...
/**
 * Get tenant select options / 获取租户下拉选项
...
/** Reset tenant admin password request / 重置租户管理员密码请求 */
...
/**
 * Impersonate tenant admin / 一键登录租户后台
...
// ============================================================
// Tenant admin management API / 租户管理员管理 API
// ============================================================
...
/** Create tenant admin request / 创建租户管理员请求 */
...
/**
 * Get tenant admin list / 获取租户管理员列表
 */
...
/**
 * Toggle tenant admin status / 切换租户管理员状态
 */
