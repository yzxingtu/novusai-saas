...
<template>
  <Drawer :title="$t('admin.system.emailLog.preview.title')" class="w-[680px]">
    <Spin :spinning="loading">
      <template v-if="detail">
        <!-- 基本信息 -->
        <Descriptions :column="2" bordered size="small" class="mb-4">
          <Descriptions.Item
            :label="$t('admin.system.emailLog.toAddress')"
            :span="2"
          >
            {{ detail.toAddress }}
          </Descriptions.Item>
          ...
          <Descriptions.Item
            :label="$t('admin.system.emailLog.subject')"
            :span="2"
          >
            <span class="font-medium">{{ detail.subject }}</span>
          </Descriptions.Item>
          <Descriptions.Item
            :label="$t('admin.system.emailLog.statusLabel')"
            :span="1"
          >
          ...
          <Descriptions.Item
            :label="$t('admin.system.emailLog.triggeredBy')"
            :span="1"
          >
          ...
          <Descriptions.Item
            :label="$t('admin.system.emailLog.createdAt')"
            :span="1"
          >
          ...
          <Descriptions.Item
            ...
            :label="$t('admin.system.emailLog.errorMessage')"
            :span="2"
          >
        ...
        <div
          v-else-if="detail.textBody"
          class="rounded-lg border border-border bg-muted/30 p-4"
        >
          <pre class="whitespace-pre-wrap text-sm text-foreground">{{
            detail.textBody
          }}</pre>
        </div>
        <Empty
