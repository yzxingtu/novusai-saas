    ...
    <div class="grid grid-cols-1 gap-4 sm:grid-cols-3">
        ...
        <div class="flex items-center justify-between">
          <div>
            <p class="text-sm font-medium text-muted-foreground">
              {{ $t('admin.system.systemLog.totalFiles') }}
            </p>
          ...
          <div
            class="flex h-12 w-12 items-center justify-center rounded-2xl bg-gradient-to-br from-blue-500 to-blue-600 text-white shadow-lg shadow-blue-500/30"
          >
      ...
      >
        <div class="flex items-center justify-between">
          <div>
            <p class="text-sm font-medium text-muted-foreground">
              {{ $t('admin.system.systemLog.totalSize') }}
            </p>
            <h3 class="mt-2 text-2xl font-bold text-foreground">
              <Spin v-if="statsLoading" size="small" />
          ...
          <div
            class="flex h-12 w-12 items-center justify-center rounded-2xl bg-gradient-to-br from-emerald-500 to-emerald-600 text-white shadow-lg shadow-emerald-500/30"
          >
      ...
      >
        <div class="flex items-center justify-between">
          ...
          <div
            class="flex h-12 w-12 items-center justify-center rounded-2xl bg-gradient-to-br from-purple-500 to-purple-600 text-white shadow-lg shadow-purple-500/30"
          >
            ...
            <div class="flex flex-col gap-1">
              <template v-for="cat in categories" :key="cat.code">
                ...
                >
                  ...
                  <Tag
                    :bordered="false"
                    class="!mr-0 bg-accent text-muted-foreground shadow-sm"
                  >
                    {{ cat.fileCount }}
                  </Tag>
                </div>
                ...
                <div v-show="activeCategory === cat.code" class="pl-4">
                  ...
                  >
                    <div
                      v-for="i in 3"
                      :key="i"
                      class="rounded-md bg-accent/30 px-3 py-2"
                    >
                      <Skeleton
                        :paragraph="false"
                        :title="{ width: '60%' }"
                  ...
                  >
                    <div
                      v-for="file in files"
                      :key="file.filename"
                      class="file-card group relative cursor-pointer rounded-md px-3 py-2 transition-all duration-200 ease-out hover:bg-primary/10"
                      :class="[
                    ...
                    >
                      ...
                      <div class="flex items-center gap-2">
                        ...
                        <div class="flex flex-shrink-0 items-center gap-1">
                          <Tag
                            v-if="file.isCurrent"
                            color="processing"
                            class="!mr-0 !h-5 !px-1.5 !text-[10px] !leading-5"
                          >
                      ...
                      <div
                        class="mt-1 flex items-center justify-between text-[10px] opacity-70"
                      >
                      ...
                      >
                        <button
                          class="flex h-8 items-center justify-center gap-1 rounded-md bg-primary/10 text-xs text-primary transition-colors hover:bg-primary hover:text-white disabled:cursor-not-allowed disabled:opacity-50"
                        ...
                        >
                          ...
                          <span>{{
                            downloadingFile === file.filename
                              ? $t('admin.system.systemLog.downloading')
                        ...
                        <Popconfirm
                          :title="
                            $t(
                              'admin.system.systemLog.messages.deleteConfirm',
                              { name: file.filename },
                            )
                          "
                        ...
                        >
                          <button
                            class="flex h-8 items-center justify-center gap-1 rounded-md bg-red-500/10 text-xs text-red-500 transition-colors hover:bg-red-500 hover:text-white"
                            @click.stop
                          >
                            <IconifyIcon
                              icon="lucide:trash-2"
                            ...
                            />
                            <span>{{
                              $t('admin.system.systemLog.delete')
                            }}</span>
                          </button>
                        </Popconfirm>
                      </div>
      ...
      <div class="flex flex-1 flex-col overflow-hidden bg-card">
        ...
        <div class="flex h-14 items-center justify-between border-b px-4">
          <div class="flex items-center gap-3">
            ...
            <Tag v-if="selectedFile?.isCurrent" color="success" class="!m-0">
              {{ $t('admin.system.systemLog.running') }}
            </Tag>
          </div>
          ...
          <div class="flex items-center gap-3">
            ...
            <Tooltip :title="$t('admin.system.systemLog.backToTop')">
              <Button
                ...
                size="small"
                @click="
                  logContainerRef?.scrollTo({ top: 0, behavior: 'smooth' })
                "
              >
                <template #icon>
        ...
        >
          <Spin :spinning="contentLoading" wrapper-class-name="h-full">
            <template v-if="logContent && selectedFile">
              <div class="min-w-fit p-4 font-mono text-xs leading-6">
                <div
                  ...
                  :key="index"
                  class="group relative flex border-l-2 border-transparent pl-2 hover:bg-black/5 dark:hover:bg-white/5"
                  :class="{
                ...
                >
                  ...
                  >
                    <Tooltip :title="$t('admin.system.systemLog.copyLine')">
                      <button
                        class="flex h-6 w-6 items-center justify-center rounded bg-primary/10 text-primary shadow-sm transition-colors hover:bg-primary hover:text-white"
            ...
            <div
              v-else
              class="flex h-full flex-col items-center justify-center opacity-30"
            >
