...
/*
 * Dynamic form preview — each field binds via v-model to a different Ant Design
 * component (Input, Select, Switch, DatePicker, Rate, Slider, etc.).
 * The value type depends on which component renders at runtime. A concrete union
 * type (string | number | boolean | ...) is incompatible with all component
 * v-model signatures simultaneously, causing 20+ compile errors.
 * Using a permissive base type is intentional and contained to this preview.
 */
