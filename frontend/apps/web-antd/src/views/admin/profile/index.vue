...
import { uploadAttachmentApi } from '#/api/admin/attachment';
import {
...
async function handleChangePassword() {
  ...
  try {
    ...
    message.success($t('admin.profile.messages.passwordChanged'));
    passwordForm.value = {
      oldPassword: '',
      newPassword: '',
      confirmPassword: '',
    ...
    message.error($t('admin.profile.messages.passwordFailed'));
  } finally {
    ...
    <Spin :spinning="loading">
      ...
      <Card class="mt-6 border-0 shadow-sm">
        <Tabs v-model:active-key="activeTab">
          <Tabs.TabPane key="basic" :tab="$t('admin.profile.tabs.basic')">
          ...
          <Tabs.TabPane key="password" :tab="$t('admin.profile.tabs.password')">
            <div class="max-w-lg py-4">
              <Form layout="vertical">
