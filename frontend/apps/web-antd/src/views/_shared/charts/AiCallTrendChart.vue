...
function render() {
  ...
  renderEcharts({
    ...
    legend: {
      data: [
        $t(`${props.i18nPrefix}.chart.calls`),
        $t(`${props.i18nPrefix}.chart.success`),
        $t(`${props.i18nPrefix}.chart.failed`),
      ],
      bottom: 0,
    },
    ...
    series: [
      {
        name: $t(`${props.i18nPrefix}.chart.calls`),
        type: 'line',
        data: props.data.map((i) => i.calls),
        smooth: true,
        itemStyle: { color: '#5B8FF9' },
      },
      {
        name: $t(`${props.i18nPrefix}.chart.success`),
        type: 'line',
      ...
      {
        name: $t(`${props.i18nPrefix}.chart.failed`),
        type: 'line',
