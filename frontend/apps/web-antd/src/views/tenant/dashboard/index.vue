...
const statCards = computed(() => [
  {
    key: 'users',
    label: $t('tenant.dashboard.stats.totalUsers'),
  ...
  {
    key: 'active',
    label: $t('tenant.dashboard.stats.activeUsers'),
  ...
  {
    key: 'tokens',
    label: $t('tenant.dashboard.stats.totalTokens'),
  ...
  {
    key: 'cost',
    label: $t('tenant.dashboard.stats.totalCost'),
    value: `$${stats.value.total_cost.toFixed(2)}`,
