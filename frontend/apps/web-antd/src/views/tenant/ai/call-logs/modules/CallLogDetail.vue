...
const detail = ref<null | TenantAICallLogInfo>(null);
    ...
    <Spin :spinning="loading">
      <template v-if="detail">
        <Descriptions bordered :column="2" size="small">
          ...
          <Descriptions.Item
            :label="$t('tenant.ai.callLog.providerName')"
            :span="1"
          >
          ...
          <Descriptions.Item
            :label="$t('tenant.ai.callLog.inputTokens')"
            :span="1"
          >
            {{ detail.input_tokens }}
          </Descriptions.Item>
          <Descriptions.Item
            :label="$t('tenant.ai.callLog.outputTokens')"
            :span="1"
          >
            {{ detail.output_tokens }}
          </Descriptions.Item>
          <Descriptions.Item
            :label="$t('tenant.ai.callLog.totalTokens')"
            :span="1"
          >
            {{ detail.total_tokens }}
          </Descriptions.Item>
          ...
          <Descriptions.Item
            :label="$t('tenant.ai.callLog.requestType')"
            :span="1"
          >
            {{ detail.request_type }}
          </Descriptions.Item>
        ...
        <template v-if="detail.error_message">
          <div class="mt-4">
            ...
            <pre
              class="rounded-lg bg-destructive/5 p-3 text-sm text-destructive"
        ...
        <template v-if="detail.request_data">
          <div class="mt-4">
            ...
            <pre
              class="max-h-[300px] overflow-auto rounded-lg bg-accent p-3 text-xs"
