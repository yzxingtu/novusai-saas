...
const columns = [
  ...
  { title: $t('tenant.ai.model.providerName'), dataIndex: 'provider_name', key: 'provider_name', width: 120 },
            ...
            <template v-else-if="column.key === 'name'">
              <div class="flex items-center gap-2">
                ...
                <div class="flex flex-col gap-0.5">
                  ...
                  <div v-if="record.supports_function_calling || record.supports_vision || record.supports_streaming" class="flex flex-wrap gap-1">
                    <Tag
