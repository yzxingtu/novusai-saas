        ...
        <Spin :spinning="loading">
          ...
          >
            ...
            <p class="text-sm text-muted-foreground">
              {{ $t('tenant.knowledgeBase.searchTest.noResults') }}
            </p>
          </div>
            ...
            >
              ...
              >
                <Tooltip
                  ...
                  :title="$t('tenant.knowledgeBase.document.viewChunks')"
                >
                  <Button
                    type="text"
                    size="small"
                ...
                <Tooltip
                  v-if="isTenantOwned && doc.status === 'error'"
                  :title="$t('tenant.knowledgeBase.document.retry')"
                >
                  <Button
                    type="text"
                    size="small"
