"""Drop ephemeral documents

Revision ID: 20260401_drop_ephem_docs
Revises: 20260331_0010_sgs
...
def downgrade() -> None:
    op.create_table(
        ...
        sa.Column(
            ...
            sa.String(length=50),
            nullable=False,
            server_default="conversation_scoped",
        ),
        ...
        sa.Column(
            ...
            nullable=False,
            server_default="Ephemeral Document",
        ),
        sa.Column(
            "content_kind",
            sa.String(length=20),
    ...
    op.create_index(
        "ix_ephemeral_documents_tenant_id",
        "ephemeral_documents",
        ["tenant_id"],
        unique=False,
    )
    op.create_index(
        "ix_ephemeral_documents_conversation_id",
        "ephemeral_documents",
        ["conversation_id"],
        unique=False,
    )
    op.create_index(
        "ix_ephemeral_documents_agent_id",
        "ephemeral_documents",
        ["agent_id"],
        unique=False,
    )
    op.create_index(
        "ix_ephemeral_documents_user_id",
        "ephemeral_documents",
        ["user_id"],
        unique=False,
    )
    op.create_index(
        "ix_ephemeral_documents_scope_type",
        "ephemeral_documents",
        ["scope_type"],
        unique=False,
    )
    op.create_index(
        "ix_ephemeral_documents_scope_key",
        "ephemeral_documents",
        ["scope_key"],
        unique=False,
    )
    op.create_index(
        "ix_ephemeral_documents_content_hash",
        "ephemeral_documents",
        ["content_hash"],
        unique=False,
    )
    op.create_index(
        "ix_ephemeral_documents_status",
        "ephemeral_documents",
        ["status"],
        unique=False,
    )
    op.create_index(
        "ix_ephemeral_documents_expires_at",
        "ephemeral_documents",
        ["expires_at"],
        unique=False,
    )
