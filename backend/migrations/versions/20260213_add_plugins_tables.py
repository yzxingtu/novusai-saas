...
def upgrade() -> None:
    ...
    op.create_table(
        'plugins',
        sa.Column('name', sa.String(), nullable=False, comment='插件唯一标识'),
        sa.Column('display_name', sa.String(), nullable=False, comment='插件显示名称'),
        sa.Column('version', sa.String(), nullable=False, comment='当前版本号（semver）'),
        sa.Column('description', sa.Text(), nullable=True, comment='插件描述'),
        sa.Column('author', sa.String(), nullable=True, comment='作者'),
        sa.Column('plugin_type', sa.String(), nullable=False, comment='插件类型'),
        sa.Column('status', sa.String(), nullable=False, comment='插件状态'),
        sa.Column('entry_point', sa.String(), nullable=False, comment='入口点'),
        ...
        sa.Column('platform_version', sa.String(), nullable=True, comment='最低平台版本要求'),
        ...
        sa.Column('icon', sa.String(), nullable=True, comment='插件图标'),
        sa.Column('homepage', sa.String(), nullable=True, comment='插件主页 URL'),
