...
def upgrade() -> None:
    op.create_table(
        ...
        sa.Column("task_id", sa.String(), nullable=False, index=True, comment="Celery Task ID"),
        sa.Column("task_name", sa.String(), nullable=False, comment="任务名称"),
        sa.Column("queue", sa.String(), nullable=False, server_default="default", comment="队列名称"),
        sa.Column("status", sa.String(), nullable=False, server_default="pending", comment="任务状态"),
