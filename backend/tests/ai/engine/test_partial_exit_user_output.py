...
Scope: recovery output rendering for partial AI dialogue exits.
Mock strategy: no LLM/provider mocks; recovery builders run real logic over fixed intent state.
"""
