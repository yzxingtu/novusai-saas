...
class ManualTestTenantOrganization(BaseAPITest):
    """企业组织架构管理测试 / Tenant organization API tests."""

    module_name = "企业组织架构管理 (/tenant/organization)"
    ...
    def setup(self) -> None:
        ...
        if config.TENANT_ADMIN_USERNAME and config.TENANT_ADMIN_PASSWORD:
            ...
            self._test_data.update(
                {
                    "primary_name": f"企业测试部门_{timestamp}",
                    "secondary_name": f"企业转移部门_{timestamp}",
                    "member_username": f"test_tenant_org_admin_{timestamp}",
                    "member_email": f"test_tenant_org_admin_{timestamp}@example.com",
                }
            )
    ...
    def teardown(self) -> None:
        ...
        for key in ("secondary_org_node_id", "primary_org_node_id"):
            ...
            if org_node_id:
                with contextlib.suppress(Exception):
                    self.client.delete(f"/tenant/organization/{org_node_id}")
    ...
    def _get_any_permission_role_id(self) -> int | None:
        ...
        data = assert_success(resp, "获取企业权限角色列表失败")
    ...
    def test_get_org_node_detail(self) -> None:
        ...
        resp = self.client.get(f"/tenant/organization/{org_node_id}")
    ...
    def test_update_org_node(self) -> None:
        ...
        resp = self.client.put(
            f"/tenant/organization/{org_node_id}",
            data={
                "name": new_name,
    ...
    def test_update_org_authority(self) -> None:
        ...
        resp = self.client.put(
            f"/tenant/organization/{org_node_id}/authority",
    ...
    def test_get_org_members(self) -> None:
        ...
        resp = self.client.get(
            f"/tenant/organization/{org_node_id}/members",
    ...
    def test_update_member_org_assignment(self) -> None:
        ...
        resp = self.client.put(
            f"/tenant/organization/{source_org_node_id}/members/{admin_id}",
            data=payload,
        )
    ...
    def test_set_leader(self) -> None:
        ...
        resp = self.client.put(
            f"/tenant/organization/{org_node_id}/leader",
    ...
    def test_delete_primary_org_node(self) -> None:
        ...
        resp = self.client.delete(f"/tenant/organization/{org_node_id}")
