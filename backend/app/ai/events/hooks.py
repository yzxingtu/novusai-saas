...
class HookPoint:
    ...
    # params: tenant_id, agent_id, result / 参数：租户、智能体、执行结果
    ...
    # params: tenant_id, conversation_id, message_id, role, content / 参数：租户、会话、消息 ID、角色、内容
    ...
    # params: tenant_id, agent_id, tool_name, result / 参数：租户、智能体、工具名、结果
    AFTER_TOOL_CALL = "after_tool_call"

    # ── LLM Call / LLM 调用 ──
    # params: tenant_id, agent_id, model, messages, config | 可修改 messages, config
    BEFORE_LLM_CALL = "before_llm_call"
    # params: tenant_id, agent_id, model, response, usage / 参数：租户、智能体、模型、响应、用量
    ...
    # params: tenant_id, skill_id, skill_data / 参数：租户、技能 ID、技能数据
    ...
    # params: tenant_id, agent_id, agent_data / 参数：租户、智能体、智能体数据
    ...
    # params: tenant_id, agent_id, conversation_id / 参数：租户、智能体、会话 ID
