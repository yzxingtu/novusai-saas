...
from app.plugins.crud_generator.codegen.enums import CodegenOperationType, CodegenRecordStatus
...
def _determine_status(write_result: dict[str, object] | None) -> str:
    """根据写入结果判断记录状态"""
