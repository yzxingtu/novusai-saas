...
/**
 * Permissive value type for dynamic form preview bindings.
 *
 * FormPreview.vue renders ~15 different Ant Design components (Input, Select,
 * Switch, DatePicker, Rate, Slider, etc.) from a single `reactive<Record>`.
 * Each component's `v-model:value` expects a different narrow type. No finite
 * union satisfies all simultaneously without causing 20+ compile errors.
 *
 * This type is intentionally broad and ONLY used in the preview component.
 */
