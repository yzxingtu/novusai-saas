...
RECYCLABLE_MODULES: dict[str, dict[str, Any]] = {
    ...
    "skill_packages": {
        ...
        "columns": ["name", "is_active", "is_system", "created_at"],
        "services": {
            "admin": "app.services.ai.skill_package_service.AdminSkillPackageService",
        },
    },
    "periodic_tasks": {
        "model": "app.models.system.task_definition.TaskDefinition",
        "label_field": "name",
        ...
        "services": {
            "admin": "app.services.system.task_definition_service.TaskDefinitionService",
        },
    },
    "tenant_plans": {
