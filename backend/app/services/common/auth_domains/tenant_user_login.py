"""Tenant-user password login flow."""
...
class TenantUserLoginDomain:
    """Password-based login and token issuance for tenant users."""
...
class TenantUserTokenDomain:
    """Token refresh handling for tenant users."""
...
class TenantUserAccountDomain:
    """Tenant user registration, profile, and password flows."""
