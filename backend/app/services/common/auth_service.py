...
class AuthService(AuthCaptchaVerificationMixin):
    ...
    def __init__(self, db: AsyncSession):
        ...
        self.token_sessions = _TokenSessionFacade(self)
        self.token_session = self.token_sessions
        self.admin_auth = _AdminAuthFacade(self)
        self.tenant_admin_auth = _TenantAdminAuthFacade(self)
        self.tenant_user_auth = _TenantUserAuthFacade(self)
