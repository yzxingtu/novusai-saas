...
def bind_turn_projector(
    *,
    ...
    return AgentChatTurnProjectionService.bind(
        context_diagnostics_builder=lambda result: AgentChatTurnProjectionService.build_context_diagnostics(
            result,
            interaction_mode_effective=interaction_mode_effective,
        ),
        last_run_summary_builder=lambda result: AgentChatTurnProjectionService.build_last_run_summary(
            result,
            interaction_mode_effective=interaction_mode_effective,
