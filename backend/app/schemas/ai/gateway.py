...
class ChatMessage(BaseModel):
    ...
    tool_calls: Optional[List[ToolCall]] = Field(default=None, description="Tool call list")
...
class UsageInfo(BaseModel):
    ...
    cost: Optional[Decimal] = Field(None, description="Cost (USD)")
...
class ChatRequest(BaseModel):
    ...
    max_tokens: Optional[int] = Field(default=None, ge=1, description="Max generation tokens")
    top_p: float = Field(default=1.0, ge=0, le=1, description="Top-p (nucleus sampling)")
    tools: Optional[List[ToolDefinition]] = Field(default=None, description="Tool list")
...
class ModelTestRequest(BaseModel):
    ...
    stream: bool = Field(default=False, description="Enable streaming response")
    temperature: float = Field(default=0.7, ge=0, le=2, description="Temperature")
    max_tokens: Optional[int] = Field(default=500, ge=1, description="Max generation tokens")
