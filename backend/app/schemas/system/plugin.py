...
class PluginResponse(BaseSchema):
    ...
    scope: str = Field("all_tenants", description="作用域")
...
class PluginCreateRequest(BaseSchema):
    ...
    scope: str = Field("all_tenants", description="作用域（platform_only/all_tenants/assigned_tenants/global）")
...
class PluginUpdateRequest(BaseSchema):
    ...
    scope: str | None = Field(None, description="作用域（platform_only/all_tenants/assigned_tenants/global）")
