...
class AdminAIActionLogRepository(BaseRepository[AIActionLog]):
    """
    平台端 AI 操作审计日志 Repository / Admin AI Action Log Repository.

    无 tenant_id 隔离，支持平台端全局审计查询。
    """
...
__all__ = ["AIActionLogRepository", "AdminAIActionLogRepository"]
