...
def upgrade():
    ...
    op.create_table(
        ...
        *_base_columns(),
        ...
        sa.Column(
            "run_id",
            sa.Integer(),
            sa.ForeignKey("px_storage_billing_runs.id", ondelete="CASCADE"),
            nullable=False,
        ),
        ...
        sa.Column(
            "currency", sa.String(length=8), server_default="CNY", nullable=False
        ),
        sa.Column(
            "amount_total", sa.Numeric(18, 6), server_default="0", nullable=False
        ),
    ...
    op.create_table(
        ...
        *_base_columns(),
        ...
        sa.Column(
            ...
            sa.Integer(),
            sa.ForeignKey(
                "px_storage_billing_provider_sources.id", ondelete="SET NULL"
            ),
            nullable=True,
        ),
        sa.Column(
            ...
            sa.Integer(),
            sa.ForeignKey(
                "px_storage_billing_tenant_statements.id", ondelete="SET NULL"
            ),
            nullable=True,
        ),
        sa.Column(
    ...
    op.create_index(
        "ix_px_storage_billing_tenant_daily_charges_statement",
        "px_storage_billing_tenant_daily_charges",
        ["statement_id"],
    )
