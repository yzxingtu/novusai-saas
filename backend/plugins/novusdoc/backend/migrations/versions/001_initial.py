...
def upgrade():
    ...
    if "px_novusdoc_folders" not in existing_tables:
        op.create_table(
            ...
            sa.Column(
                "is_deleted", sa.Boolean(), nullable=False, default=False, index=True
            ),
    ...
    if "px_novusdoc_documents" not in existing_tables:
        op.create_table(
            ...
            sa.Column(
                "content", sa.JSON(), nullable=True, comment="Tiptap JSON content"
            ),
            sa.Column(
                "content_text",
                sa.Text(),
            ...
            sa.Column(
                "content_html", sa.Text(), nullable=True, comment="HTML export cache"
            ),
