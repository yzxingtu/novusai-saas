(function(E,e){typeof exports=="object"&&typeof module<"u"?e(exports,require("vue"),require("@novus/plugin-shared"),require("ant-design-vue")):typeof define=="function"&&define.amd?define(["exports","vue","@novus/plugin-shared","ant-design-vue"],e):(E=typeof globalThis<"u"?globalThis:E||self,e(E.NovusPlugin_weather_widget={},E.Vue,E.NovusPluginShared,E.AntDesignVue))})(this,(function(E,e,t,Ye){"use strict";const Qe=[{name:"北京",latitude:39.9042,longitude:116.4074,country:"China"},{name:"上海",latitude:31.2304,longitude:121.4737,country:"China"},{name:"广州",latitude:23.1291,longitude:113.2644,country:"China"},{name:"深圳",latitude:22.5431,longitude:114.0579,country:"China"},{name:"杭州",latitude:30.2741,longitude:120.1551,country:"China"},{name:"成都",latitude:30.5728,longitude:104.0668,country:"China"},{name:"武汉",latitude:30.5928,longitude:114.3055,country:"China"},{name:"南京",latitude:32.0603,longitude:118.7969,country:"China"},{name:"重庆",latitude:29.4316,longitude:106.9123,country:"China"},{name:"西安",latitude:34.3416,longitude:108.9398,country:"China"},{name:"苏州",latitude:31.299,longitude:120.5853,country:"China"},{name:"天津",latitude:39.3434,longitude:117.3616,country:"China"}],pe="novusai_weather_config",xe="novusai_weather_data",Xe=6,Je=600,W={city:"Shanghai",latitude:31.2304,longitude:121.4737,recentCities:[{name:"Shanghai",latitude:31.2304,longitude:121.4737,country:"China"}]},G=e.ref(!1);function we(n,r,l){return Math.max(r,Math.min(l,n))}function A(){return`${window.location.pathname.startsWith("/admin")?"/admin":"/tenant"}/plugins/weather-widget/api`}function Ke(n){return n==="fahrenheit"?"fahrenheit":"celsius"}function Ge(){try{const n=localStorage.getItem(pe);if(G.value=!!n,n){const r=JSON.parse(n);return{city:r.city||W.city,latitude:r.latitude??W.latitude,longitude:r.longitude??W.longitude,recentCities:Array.isArray(r.recentCities)&&r.recentCities.length>0?r.recentCities:W.recentCities}}}catch{G.value=!1}return{...W,recentCities:[...W.recentCities]}}function te(n){try{localStorage.setItem(pe,JSON.stringify(n)),G.value=!0}catch{}}function ge(){try{const n=localStorage.getItem(xe);if(n)return JSON.parse(n)}catch{}return null}function Ze(n){try{localStorage.setItem(xe,JSON.stringify(n))}catch{}}const m=e.ref(Ge()),B=e.ref({}),P=e.ref(null),O=e.ref([]),H=e.ref([]),Y=e.ref(null),ne=e.ref(!1),ae=e.ref(!0),oe=e.ref(null),re=e.ref(!1),Q=e.ref(null),fe=e.ref(!1),ie=e.ref(!1),U=e.ref(null);let C=null,X=0,he=!1,Z=0,S=null,F=null;function ue(n,r){if(!n){ie.value=!1;return}ie.value=Date.now()-n>r}function ve(n,r,l){S&&(clearInterval(S),S=null),!(!r||X<=0)&&(S=setInterval(()=>{l()},n))}function et(){const n=e.computed(()=>m.value.city),r=e.computed(()=>m.value.recentCities),l=e.computed(()=>Ke(B.value.temperature_unit)),s=e.computed(()=>we(B.value.forecast_days??3,1,7)),N=e.computed(()=>we(B.value.cache_ttl??Je,60,3600)*1e3),$=e.computed(()=>Math.max(N.value,300*1e3));async function R(){try{const o=await t.requestClient.get(`${A()}/config`);o!=null&&o.config&&(B.value=o.config)}catch{B.value={}}}async function D(){var g;const o=(g=B.value.default_city)==null?void 0:g.trim();if(!o||G.value)return;const w=await j(o);if(w.length>0){const f=w[0];m.value.city=f.name,m.value.latitude=f.latitude,m.value.longitude=f.longitude,m.value.recentCities=[f],te(m.value);return}m.value.city=o,te(m.value)}async function V(){const o=++Z;F&&F.abort(),F=new AbortController,ne.value=!0,oe.value=null;const{latitude:w,longitude:g}=m.value,f=s.value;try{const[_,b,x,d]=await Promise.all([t.requestClient.get(`${A()}/current`,{params:{lat:w,lon:g},signal:F.signal}),t.requestClient.get(`${A()}/forecast`,{params:{lat:w,lon:g,days:f},signal:F.signal}).catch(()=>null),t.requestClient.get(`${A()}/hourly`,{params:{lat:w,lon:g},signal:F.signal}).catch(()=>null),t.requestClient.get(`${A()}/air-quality`,{params:{lat:w,lon:g},signal:F.signal}).catch(()=>null)]);if(o!==Z)return;P.value=(_==null?void 0:_.weather)??null,O.value=((b==null?void 0:b.forecast)??[]).slice(0,f),H.value=(x==null?void 0:x.hourly)??[],Y.value=(d==null?void 0:d.air_quality)??null,U.value=Date.now(),ue(U.value,$.value),Ze({current:P.value,forecast:O.value,hourly:H.value,airQuality:Y.value,timestamp:U.value})}catch(_){if(o!==Z)return;const b=_ instanceof Error?_.message:String(_);if(b.toLowerCase().includes("aborted"))return;oe.value=b;const x=ge();x!=null&&x.current&&(P.value=x.current,O.value=x.forecast.slice(0,f),H.value=x.hourly,Y.value=x.airQuality,U.value=x.timestamp,ue(x.timestamp,$.value))}finally{o===Z&&(ne.value=!1,ae.value=!1)}}async function j(o){const w=o.trim();if(!w)return[];try{const g=await t.requestClient.get(`${A()}/geocoding`,{params:{name:w,count:8}});return(g==null?void 0:g.cities)??[]}catch{return[]}}async function h(o){m.value.city=o.name,m.value.latitude=o.latitude,m.value.longitude=o.longitude;const w=m.value.recentCities.filter(g=>!(Math.abs(g.latitude-o.latitude)<.01&&Math.abs(g.longitude-o.longitude)<.01));w.unshift(o),m.value.recentCities=w.slice(0,Xe),te(m.value),fe.value=!1,await V()}async function z(){var o,w;if(!navigator.geolocation){Q.value="locate_failed";return}re.value=!0,Q.value=null;try{const g=await new Promise((x,d)=>{navigator.geolocation.getCurrentPosition(x,d,{enableHighAccuracy:!0,timeout:1e4,maximumAge:3e5})}),{latitude:f,longitude:_}=g.coords;let b=null;for(let x=0;x<2;x+=1){try{const d=await t.requestClient.get(`${A()}/geocoding`,{params:{lat:f,lon:_}});if((o=d==null?void 0:d.cities)!=null&&o.length&&((w=d.cities[0])!=null&&w.name)){b=d.cities[0];break}}catch{}x===0&&await new Promise(d=>setTimeout(d,500))}b?await h(b):(await h({name:`${f.toFixed(2)}, ${_.toFixed(2)}`,latitude:f,longitude:_}),Q.value="locate_fallback")}catch{Q.value="locate_failed"}finally{re.value=!1}}async function I(){if(X+=1,!he){he=!0;const o=ge();o!=null&&o.current&&(P.value=o.current,O.value=o.forecast,H.value=o.hourly,Y.value=o.airQuality,U.value=o.timestamp,ae.value=!1),await R(),await D(),await V()}ve(N.value,B.value.auto_refresh??!0,V)}function q(){X=Math.max(0,X-1),X<=0&&S&&(clearInterval(S),S=null)}return{cityName:n,recentCities:r,current:P,forecast:O,hourly:H,airQuality:Y,loading:ne,initialLoading:ae,error:oe,locating:re,locateError:Q,showCitySelector:fe,isStale:ie,pluginConfig:B,temperatureUnit:l,forecastDays:s,lastUpdatedAt:U,fetchAll:V,searchCity:j,selectCity:h,geolocate:z,mount:I,unmount:q}}function me(){return C||(C=et()),e.onMounted(()=>{C==null||C.mount()}),e.onBeforeUnmount(()=>{C==null||C.unmount()}),C}function _e(n,r){return r?n.weather_text_zh||n.weather_text_en||"--":n.weather_text_en||n.weather_text_zh||"--"}function tt(n,r){return n==null||Number.isNaN(n)?null:r==="fahrenheit"?n*9/5+32:n}function k(n,r,l=0){const s=tt(n,r);return s==null?"--":s.toFixed(l)}function nt(n){return n==="fahrenheit"?"F":"C"}function be(n,r,l=1){return n==null||Number.isNaN(n)?"--":(r==="fahrenheit"?n*.621371:n).toFixed(l)}function ye(n){return[n.admin1,n.country].filter(Boolean).join(" · ")}function ke(n,r){return n?new Intl.DateTimeFormat(r,{hour:"2-digit",minute:"2-digit"}).format(n):"--:--"}function Ee(n){if(!n)return"--:--";const r=n.includes("T")?n.split("T")[1]:n;return r?r.slice(0,5):"--:--"}function Ne(n){return n==null?"na":n<=50?"good":n<=100?"moderate":n<=150?"unhealthy_sensitive":n<=200?"unhealthy":n<=300?"very_unhealthy":"hazardous"}function Ve(n){return n==null?"#A7B3CC":n<=50?"#47D16D":n<=100?"#EABD43":n<=150?"#F49D58":n<=200?"#F06B67":n<=300?"#A47DE8":"#D45A8A"}function Ce(n,r,l){if(r===0)return l("plugin.weather-widget.ui.today");if(r===1)return l("plugin.weather-widget.ui.tomorrow");if(r===2)return l("plugin.weather-widget.ui.day_after");const s=new Date(n).getDay();return l(`plugin.weather-widget.ui.weekday_${s}`)}const $e={0:{icon:"sun",nightIcon:"moon",scene:"clear"},1:{icon:"sun",nightIcon:"moon",scene:"clear"},2:{icon:"cloud-sun",nightIcon:"cloud-moon",scene:"cloudy"},3:{icon:"cloud",scene:"cloudy"},45:{icon:"cloud-fog",scene:"fog"},48:{icon:"cloud-fog",scene:"fog"},51:{icon:"cloud-drizzle",scene:"drizzle"},53:{icon:"cloud-drizzle",scene:"drizzle"},55:{icon:"cloud-drizzle",scene:"drizzle"},56:{icon:"cloud-drizzle",scene:"drizzle"},57:{icon:"cloud-drizzle",scene:"drizzle"},61:{icon:"cloud-rain",scene:"rain"},63:{icon:"cloud-rain",scene:"rain"},65:{icon:"cloud-rain",scene:"rain"},66:{icon:"cloud-rain",scene:"rain"},67:{icon:"cloud-rain",scene:"rain"},71:{icon:"snowflake",scene:"snow"},73:{icon:"snowflake",scene:"snow"},75:{icon:"snowflake",scene:"snow"},77:{icon:"snowflake",scene:"snow"},80:{icon:"cloud-rain",scene:"rain"},81:{icon:"cloud-rain",scene:"rain"},82:{icon:"cloud-rain",scene:"rain"},85:{icon:"snowflake",scene:"snow"},86:{icon:"snowflake",scene:"snow"},95:{icon:"cloud-lightning",scene:"thunderstorm"},96:{icon:"cloud-lightning",scene:"thunderstorm"},99:{icon:"cloud-lightning",scene:"thunderstorm"}},ze={icon:"cloud",scene:"cloudy"};function Be(n,r=!0){const l=$e[n]??ze;return{icon:!r&&l.nightIcon?l.nightIcon:l.icon,scene:l.scene}}const at={"clear-day":{bgClass:"wx-bg--clear-day",scene:"sun"},"clear-night":{bgClass:"wx-bg--clear-night",scene:"moon-star"},"cloudy-day":{bgClass:"wx-bg--cloudy-day",scene:"cloud"},"cloudy-night":{bgClass:"wx-bg--cloudy-night",scene:"cloud"},"fog-day":{bgClass:"wx-bg--fog",scene:"fog"},"fog-night":{bgClass:"wx-bg--fog",scene:"fog"},"drizzle-day":{bgClass:"wx-bg--rain-day",scene:"rain"},"drizzle-night":{bgClass:"wx-bg--rain-night",scene:"rain"},"rain-day":{bgClass:"wx-bg--rain-day",scene:"rain"},"rain-night":{bgClass:"wx-bg--rain-night",scene:"rain"},"snow-day":{bgClass:"wx-bg--snow-day",scene:"snow"},"snow-night":{bgClass:"wx-bg--snow-night",scene:"snow"},"thunderstorm-day":{bgClass:"wx-bg--thunder",scene:"thunder"},"thunderstorm-night":{bgClass:"wx-bg--thunder",scene:"thunder"}};function De(n,r=!0){const l=$e[n]??ze,s=r?"day":"night",N=`${l.scene}-${s}`;return at[N]??{bgClass:"wx-bg--cloudy-day",scene:"cloud"}}const ot={class:"wx-dashboard-shell"},rt={class:"wx-dashboard__topbar"},it={class:"wx-dashboard__eyebrow"},lt=["disabled","aria-label"],st={class:"wx-dashboard__hero"},ct={class:"wx-dashboard__hero-main"},dt={class:"wx-dashboard__temp"},pt={class:"wx-dashboard__condition-wrap"},xt={class:"wx-dashboard__condition-line"},wt={class:"wx-dashboard__icon-wrap"},gt={class:"wx-dashboard__condition"},ft={class:"wx-dashboard__meta"},ht={class:"wx-dashboard__chip-row"},ut={key:0,class:"wx-dashboard__forecast-ribbon"},mt={class:"wx-dashboard__forecast-head"},_t={class:"wx-dashboard__forecast-range"},bt={class:"wx-dashboard__forecast-text"},yt={key:1,class:"wx-dashboard-skeleton"},kt={key:2,class:"wx-dashboard-empty"},Et={class:"wx-dashboard-empty__title"},Nt={key:0,class:"wx-dashboard-empty__desc"},Vt=e.defineComponent({__name:"WeatherDashboardWidget",setup(n){const{cityName:r,current:l,forecast:s,airQuality:N,loading:$,initialLoading:R,error:D,isStale:V,lastUpdatedAt:j,temperatureUnit:h,fetchAll:z}=me(),I=e.computed(()=>t.$t("plugin.weather-widget._meta.lang")==="zh"),q=e.computed(()=>s.value.slice(0,3)),o=e.computed(()=>l.value?De(l.value.weather_code,l.value.is_day):{bgClass:"wx-bg--cloudy-day",scene:"cloud"}),w=e.computed(()=>ke(j.value,I.value?"zh-CN":"en-US")),g=e.computed(()=>V.value?t.$t("plugin.weather-widget.ui.cached_data"):t.$t("plugin.weather-widget.ui.live_data")),f=e.computed(()=>h.value==="fahrenheit"?t.$t("plugin.weather-widget.ui.unit_mph"):t.$t("plugin.weather-widget.ui.unit_kmh")),_=e.computed(()=>{var d,u,p;return l.value?[{key:"humidity",label:t.$t("plugin.weather-widget.ui.humidity"),note:void 0,tone:void 0,value:`${l.value.humidity??"--"}%`,wide:!1},{key:"wind",label:t.$t("plugin.weather-widget.ui.wind_speed"),note:void 0,tone:void 0,value:`${be(l.value.wind_speed,h.value)} ${f.value}`,wide:!1},{key:"aqi",label:t.$t("plugin.weather-widget.ui.aqi"),value:`${((d=N.value)==null?void 0:d.aqi)??"--"}`,note:t.$t(`plugin.weather-widget.aqi_level.${Ne((u=N.value)==null?void 0:u.aqi)}`),tone:Ve((p=N.value)==null?void 0:p.aqi),wide:!0}]:[]});function b(d){return _e(d,I.value)}function x(d,u=!0){return Be(d,u).icon}return(d,u)=>(e.openBlock(),e.createElementBlock("div",ot,[e.unref(l)?(e.openBlock(),e.createElementBlock("section",{key:0,class:e.normalizeClass(["wx-dashboard wx-noise",[o.value.bgClass,`wx-scene--${o.value.scene}`]])},[u[2]||(u[2]=e.createStaticVNode('<div class="wx-panel__veil wx-panel__veil--dashboard"></div><div class="wx-scene wx-scene--dashboard" aria-hidden="true"><span class="wx-scene__orb"></span><span class="wx-scene__cloud wx-scene__cloud--1"></span><span class="wx-scene__cloud wx-scene__cloud--2"></span><span class="wx-scene__spark wx-scene__spark--1"></span><span class="wx-scene__spark wx-scene__spark--2"></span><span class="wx-scene__drop wx-scene__drop--1"></span><span class="wx-scene__drop wx-scene__drop--2"></span><span class="wx-scene__flake wx-scene__flake--1"></span><span class="wx-scene__mist wx-scene__mist--1"></span><span class="wx-scene__flash"></span></div>',2)),e.createElementVNode("div",rt,[e.createElementVNode("div",it,[e.createElementVNode("span",null,e.toDisplayString(e.unref(r)),1),e.createElementVNode("span",null,e.toDisplayString(g.value),1)]),e.createElementVNode("button",{type:"button",class:"wx-icon-btn",disabled:e.unref($),"aria-label":e.unref(t.$t)("plugin.weather-widget.ui.refresh"),onClick:u[0]||(u[0]=(...p)=>e.unref(z)&&e.unref(z)(...p))},[e.createVNode(e.unref(t.IconifyIcon),{icon:e.unref($)?"lucide:loader-2":"lucide:refresh-cw",class:e.normalizeClass(e.unref($)?"size-4 animate-spin":"size-4")},null,8,["icon","class"])],8,lt)]),e.createElementVNode("div",st,[e.createElementVNode("div",ct,[e.createElementVNode("div",dt,e.toDisplayString(e.unref(k)(e.unref(l).temperature,e.unref(h)))+"° ",1),e.createElementVNode("div",pt,[e.createElementVNode("div",xt,[e.createElementVNode("div",wt,[e.createVNode(e.unref(t.IconifyIcon),{icon:`lucide:${x(e.unref(l).weather_code,e.unref(l).is_day)}`,class:"wx-dashboard__icon"},null,8,["icon"])]),e.createElementVNode("div",gt,e.toDisplayString(b(e.unref(l))),1)]),e.createElementVNode("div",ft,[e.createElementVNode("span",null,e.toDisplayString(e.unref(t.$t)("plugin.weather-widget.ui.feels_like"))+" "+e.toDisplayString(e.unref(k)(e.unref(l).apparent_temperature,e.unref(h)))+"° ",1),e.createElementVNode("span",null,e.toDisplayString(e.unref(t.$t)("plugin.weather-widget.ui.last_updated"))+" "+e.toDisplayString(w.value),1)])])])]),e.createElementVNode("div",ht,[(e.openBlock(!0),e.createElementBlock(e.Fragment,null,e.renderList(_.value,p=>(e.openBlock(),e.createElementBlock("article",{key:p.key,class:e.normalizeClass(["wx-dashboard__chip",p.wide?"wx-dashboard__chip--wide":""])},[e.createElementVNode("span",null,e.toDisplayString(p.label),1),e.createElementVNode("strong",{style:e.normalizeStyle(p.tone?{color:p.tone}:void 0)},e.toDisplayString(p.value),5),p.note?(e.openBlock(),e.createElementBlock("small",{key:0,style:e.normalizeStyle(p.tone?{color:p.tone}:void 0)},e.toDisplayString(p.note),5)):e.createCommentVNode("",!0)],2))),128))]),q.value.length>0?(e.openBlock(),e.createElementBlock("div",ut,[(e.openBlock(!0),e.createElementBlock(e.Fragment,null,e.renderList(q.value,(p,M)=>(e.openBlock(),e.createElementBlock("article",{key:p.date,class:"wx-dashboard__forecast-pill"},[e.createElementVNode("div",mt,[e.createElementVNode("span",null,e.toDisplayString(e.unref(Ce)(p.date,M,e.unref(t.$t))),1),e.createVNode(e.unref(t.IconifyIcon),{icon:`lucide:${x(p.weather_code,!0)}`,class:"size-4"},null,8,["icon"])]),e.createElementVNode("div",_t,[e.createElementVNode("span",null,e.toDisplayString(e.unref(k)(p.temp_max,e.unref(h)))+"°",1),e.createElementVNode("span",null,e.toDisplayString(e.unref(k)(p.temp_min,e.unref(h)))+"°",1)]),e.createElementVNode("div",bt,e.toDisplayString(b(p)),1)]))),128))])):e.createCommentVNode("",!0)],2)):e.unref(R)?(e.openBlock(),e.createElementBlock("div",yt,[...u[3]||(u[3]=[e.createStaticVNode('<div class="wx-skeleton wx-skeleton--lg"></div><div class="wx-dashboard-skeleton__row"><div class="wx-skeleton wx-skeleton--tile"></div><div class="wx-skeleton wx-skeleton--tile"></div><div class="wx-skeleton wx-skeleton--tile"></div></div><div class="wx-dashboard-skeleton__row"><div class="wx-skeleton wx-skeleton--tile"></div><div class="wx-skeleton wx-skeleton--tile"></div><div class="wx-skeleton wx-skeleton--tile"></div></div>',3)])])):(e.openBlock(),e.createElementBlock("div",kt,[e.createVNode(e.unref(t.IconifyIcon),{icon:"lucide:cloud-off",class:"size-10 text-muted-foreground"}),e.createElementVNode("div",Et,e.toDisplayString(e.unref(t.$t)("plugin.weather-widget.ui.error")),1),e.unref(D)?(e.openBlock(),e.createElementBlock("div",Nt,e.toDisplayString(e.unref(D)),1)):e.createCommentVNode("",!0),e.createElementVNode("button",{type:"button",class:"wx-action-btn",onClick:u[1]||(u[1]=(...p)=>e.unref(z)&&e.unref(z)(...p))},[e.createVNode(e.unref(t.IconifyIcon),{icon:"lucide:refresh-cw",class:"size-4"}),e.createTextVNode(" "+e.toDisplayString(e.unref(t.$t)("plugin.weather-widget.ui.retry")),1)])]))]))}}),Ct=["aria-label","aria-expanded"],$t={class:"wx-trigger__icon-wrap"},zt={class:"wx-trigger__copy"},Bt={key:"city-selector",class:"wx-city-panel"},Dt={class:"wx-city-panel__head"},It=["aria-label"],Tt=["aria-label"],Lt={class:"wx-city-panel__summary"},At={class:"wx-city-panel__label"},St={class:"wx-search"},Ft=["value","placeholder"],Rt={class:"wx-city-list"},qt={key:0},Mt={key:0,class:"wx-state-line"},Wt=["onClick"],Ut={class:"wx-city-chip__main"},jt={class:"truncate"},Pt={key:0,class:"wx-city-chip__meta"},Ot={key:1,class:"wx-state-line"},Ht=["disabled","aria-label"],Yt={key:1,class:"wx-state-line wx-state-line--error"},Qt={key:2,class:"wx-city-group"},Xt={class:"wx-city-grid"},Jt=["onClick"],Kt={class:"truncate"},Gt={class:"wx-city-group"},Zt={class:"wx-city-grid"},vt=["onClick"],en={class:"truncate"},tn={key:"weather-main",class:"wx-main-panel"},nn={key:0,class:"wx-skeleton-wrap"},an={key:1,class:"wx-empty"},on={class:"wx-main-head"},rn=["aria-label"],ln={class:"truncate"},sn={class:"wx-head-actions"},cn={class:"wx-status-chip"},dn=["disabled","aria-label"],pn=["disabled","aria-label"],xn={class:"wx-hero"},wn={class:"wx-hero__eyebrow"},gn={class:"wx-hero__body"},fn={class:"wx-hero__copy"},hn={class:"wx-hero__temp"},un={class:"wx-hero__text"},mn={class:"wx-hero__sub"},_n={key:0},bn={class:"wx-hero__meta"},yn={class:"wx-hero__icon-shell"},kn={class:"wx-hero__unit"},En={key:0,class:"wx-stale-badge"},Nn={class:"wx-chip-grid"},Vn={key:0,class:"wx-hourly-band"},Cn={class:"wx-section-head wx-section-head--inline"},$n={class:"wx-hour-item__time"},zn={class:"wx-hour-item__temp"},Bn={class:"wx-sun-strip"},Dn={class:"wx-sun-chip"},In={class:"wx-sun-chip"},Tn={key:1,class:"wx-forecast-sheet"},Ln={class:"wx-section-head wx-section-head--inline"},An={class:"wx-forecast-row__day"},Sn={class:"wx-forecast-row__temp"},Fn=e.defineComponent({__name:"WeatherHeaderWidget",setup(n){const{cityName:r,recentCities:l,current:s,forecast:N,hourly:$,airQuality:R,loading:D,initialLoading:V,error:j,locating:h,locateError:z,showCitySelector:I,isStale:q,temperatureUnit:o,forecastDays:w,lastUpdatedAt:g,fetchAll:f,searchCity:_,selectCity:b,geolocate:x}=me(),d=e.ref(!1),u=e.ref(""),p=e.ref([]),M=e.ref(!1),Le=e.ref(null),le=e.ref(null),se=e.ref(null),Ae=e.ref({});let J=null,v=null;const Se=e.computed(()=>t.$t("plugin.weather-widget._meta.lang")==="zh"),Fe=e.computed(()=>nt(o.value)),Mn=e.computed(()=>o.value==="fahrenheit"?t.$t("plugin.weather-widget.ui.unit_mph"):t.$t("plugin.weather-widget.ui.unit_kmh")),K=e.computed(()=>N.value[0]??null),Re=e.computed(()=>N.value.slice(0,Math.min(w.value,3))),qe=e.computed(()=>$.value.slice(0,6)),Me=e.computed(()=>q.value?t.$t("plugin.weather-widget.ui.cached_data"):t.$t("plugin.weather-widget.ui.live_data")),Wn=e.computed(()=>ke(g.value,Se.value?"zh-CN":"en-US")),We=e.computed(()=>s.value?De(s.value.weather_code,s.value.is_day):{bgClass:"wx-bg--cloudy-day",scene:"cloud"}),Un=e.computed(()=>{var c,i,y;return s.value?[{key:"humidity",label:t.$t("plugin.weather-widget.ui.humidity"),note:void 0,tone:void 0,value:`${s.value.humidity??"--"}%`},{key:"wind",label:t.$t("plugin.weather-widget.ui.wind_speed"),note:void 0,tone:void 0,value:`${be(s.value.wind_speed,o.value)} ${Mn.value}`},{key:"uv",label:t.$t("plugin.weather-widget.ui.uv_index"),note:void 0,tone:void 0,value:`${s.value.uv_index??"--"}`},{key:"aqi",label:t.$t("plugin.weather-widget.ui.aqi"),value:`${((c=R.value)==null?void 0:c.aqi)??"--"}`,note:Pn((i=R.value)==null?void 0:i.aqi),tone:Ve((y=R.value)==null?void 0:y.aqi)}]:[]});function ee(c,i=!0){return Be(c,i).icon}function Ue(c){return _e(c,Se.value)}function jn(c,i){return i?t.$t("plugin.weather-widget.ui.now"):c}function Pn(c){const i=Ne(c);return t.$t(`plugin.weather-widget.aqi_level.${i}`)}function On(){return Math.max(Math.min(360,window.innerWidth-20),0)}function Hn(){var He;const c=le.value;if(!c||!c.isConnected){d.value=!1;return}const i=4,y=10,T=c.getBoundingClientRect(),a=((He=se.value)==null?void 0:He.offsetWidth)??On(),L=Math.max(window.innerWidth-a-y,y),Jn=Math.min(Math.max(T.right-a,y),L);Ae.value={left:`${Jn}px`,top:`${Math.max(T.bottom+i,y)}px`}}function je(c){var y,T;if(!d.value)return;const i=c.target;i&&((y=le.value)!=null&&y.contains(i)||(T=se.value)!=null&&T.contains(i)||(d.value=!1))}function Pe(c){c.key==="Escape"&&(d.value=!1)}function Yn(){ce();const c=()=>{Hn(),v=requestAnimationFrame(c)};c(),document.addEventListener("pointerdown",je,!0),window.addEventListener("keydown",Pe)}function ce(){v!=null&&(cancelAnimationFrame(v),v=null),document.removeEventListener("pointerdown",je,!0),window.removeEventListener("keydown",Pe)}function Qn(){d.value=!d.value}function Xn(c){if(u.value=c,J&&clearTimeout(J),!c.trim()){M.value=!1,p.value=[];return}M.value=!0,J=setTimeout(async()=>{p.value=await _(c.trim()),M.value=!1},260)}async function de(c){u.value="",p.value=[],await b(c)}function Oe(){e.nextTick(()=>{const c=Le.value;if(!c)return;const i=c.querySelector(".wx-hour-item--active");i&&c.scrollTo({left:Math.max(i.offsetLeft-16,0),behavior:"smooth"})})}return e.watch($,()=>{d.value&&Oe()}),e.watch(d,c=>{if(c){Oe(),e.nextTick(()=>{Yn()});return}ce()}),e.onBeforeUnmount(()=>{J&&clearTimeout(J),ce()}),(c,i)=>(e.openBlock(),e.createElementBlock(e.Fragment,null,[e.createVNode(e.unref(Ye.Tooltip),{title:e.unref(t.$t)("plugin.weather-widget.ui.open_weather"),placement:"bottom"},{default:e.withCtx(()=>[e.createElementVNode("button",{ref_key:"triggerRef",ref:le,type:"button",class:"wx-trigger","aria-label":e.unref(t.$t)("plugin.weather-widget.ui.open_weather"),"aria-expanded":d.value,onClick:Qn},[e.createElementVNode("span",$t,[e.unref(s)&&!e.unref(V)?(e.openBlock(),e.createBlock(e.unref(t.IconifyIcon),{key:0,icon:`lucide:${ee(e.unref(s).weather_code,e.unref(s).is_day)}`,class:"wx-trigger__icon"},null,8,["icon"])):e.unref(V)?(e.openBlock(),e.createBlock(e.unref(t.IconifyIcon),{key:1,icon:"lucide:loader-2",class:"wx-trigger__icon animate-spin"})):(e.openBlock(),e.createBlock(e.unref(t.IconifyIcon),{key:2,icon:"lucide:cloud-off",class:"wx-trigger__icon"}))]),e.createElementVNode("span",zt,[e.createElementVNode("small",null,e.toDisplayString(e.unref(r)),1),e.createElementVNode("strong",null,[e.unref(s)&&!e.unref(V)?(e.openBlock(),e.createElementBlock(e.Fragment,{key:0},[e.createTextVNode(e.toDisplayString(e.unref(k)(e.unref(s).temperature,e.unref(o)))+"° ",1)],64)):(e.openBlock(),e.createElementBlock(e.Fragment,{key:1},[e.createTextVNode(" -- ")],64))])])],8,Ct)]),_:1},8,["title"]),(e.openBlock(),e.createBlock(e.Teleport,{to:"body"},[d.value?(e.openBlock(),e.createElementBlock("div",{key:0,class:"weather-popover-immersive-overlay",style:e.normalizeStyle(Ae.value)},[e.createElementVNode("section",{ref_key:"panelRef",ref:se,class:e.normalizeClass(["wx-panel wx-noise",[We.value.bgClass,`wx-scene--${We.value.scene}`]])},[i[10]||(i[10]=e.createElementVNode("div",{class:"wx-panel__veil"},null,-1)),e.createVNode(e.Transition,{name:"wx-fade-slide",mode:"out-in"},{default:e.withCtx(()=>{var y,T;return[e.unref(I)?(e.openBlock(),e.createElementBlock("div",Bt,[e.createElementVNode("header",Dt,[e.createElementVNode("button",{type:"button",class:"wx-icon-btn","aria-label":e.unref(t.$t)("plugin.weather-widget.ui.back"),onClick:i[0]||(i[0]=a=>I.value=!1)},[e.createVNode(e.unref(t.IconifyIcon),{icon:"lucide:chevron-left",class:"size-4"})],8,It),e.createElementVNode("h3",null,e.toDisplayString(e.unref(t.$t)("plugin.weather-widget.ui.change_city")),1),e.createElementVNode("button",{type:"button",class:"wx-icon-btn","aria-label":e.unref(t.$t)("plugin.weather-widget.ui.close"),onClick:i[1]||(i[1]=a=>d.value=!1)},[e.createVNode(e.unref(t.IconifyIcon),{icon:"lucide:x",class:"size-4"})],8,Tt)]),e.createElementVNode("div",Lt,[e.createElementVNode("span",At,e.toDisplayString(e.unref(t.$t)("plugin.weather-widget.ui.current_city")),1),e.createElementVNode("strong",null,e.toDisplayString(e.unref(r)),1)]),e.createElementVNode("label",St,[e.createVNode(e.unref(t.IconifyIcon),{icon:"lucide:search",class:"size-4 opacity-70"}),e.createElementVNode("input",{value:u.value,placeholder:e.unref(t.$t)("plugin.weather-widget.ui.search_city"),onInput:i[2]||(i[2]=a=>Xn(a.target.value))},null,40,Ft)]),e.createElementVNode("div",Rt,[u.value.trim()?(e.openBlock(),e.createElementBlock("div",qt,[M.value?(e.openBlock(),e.createElementBlock("div",Mt,[e.createVNode(e.unref(t.IconifyIcon),{icon:"lucide:loader-2",class:"size-4 animate-spin"}),e.createTextVNode(" "+e.toDisplayString(e.unref(t.$t)("plugin.weather-widget.ui.loading")),1)])):e.createCommentVNode("",!0),(e.openBlock(!0),e.createElementBlock(e.Fragment,null,e.renderList(p.value,a=>(e.openBlock(),e.createElementBlock("button",{key:`search-${a.latitude}-${a.longitude}`,type:"button",class:"wx-city-chip",onClick:L=>de(a)},[e.createElementVNode("span",Ut,[e.createVNode(e.unref(t.IconifyIcon),{icon:"lucide:map-pin",class:"size-3.5 opacity-65"}),e.createElementVNode("span",jt,e.toDisplayString(a.name),1)]),e.unref(ye)(a)?(e.openBlock(),e.createElementBlock("span",Pt,e.toDisplayString(e.unref(ye)(a)),1)):e.createCommentVNode("",!0)],8,Wt))),128)),!M.value&&p.value.length===0?(e.openBlock(),e.createElementBlock("div",Ot,e.toDisplayString(e.unref(t.$t)("plugin.weather-widget.error.city_not_found")),1)):e.createCommentVNode("",!0)])):e.createCommentVNode("",!0),e.createElementVNode("button",{type:"button",class:"wx-locate-btn",disabled:e.unref(h),"aria-label":e.unref(t.$t)("plugin.weather-widget.ui.auto_locate"),onClick:i[3]||(i[3]=(...a)=>e.unref(x)&&e.unref(x)(...a))},[e.createVNode(e.unref(t.IconifyIcon),{icon:e.unref(h)?"lucide:loader-2":"lucide:locate",class:e.normalizeClass(e.unref(h)?"size-4 animate-spin":"size-4")},null,8,["icon","class"]),e.createTextVNode(" "+e.toDisplayString(e.unref(h)?e.unref(t.$t)("plugin.weather-widget.ui.locating"):e.unref(t.$t)("plugin.weather-widget.ui.auto_locate")),1)],8,Ht),e.unref(z)?(e.openBlock(),e.createElementBlock("div",Yt,e.toDisplayString(e.unref(t.$t)(`plugin.weather-widget.error.${e.unref(z)}`)),1)):e.createCommentVNode("",!0),e.unref(l).length>0?(e.openBlock(),e.createElementBlock("div",Qt,[e.createElementVNode("h4",null,e.toDisplayString(e.unref(t.$t)("plugin.weather-widget.ui.recent_cities")),1),e.createElementVNode("div",Xt,[(e.openBlock(!0),e.createElementBlock(e.Fragment,null,e.renderList(e.unref(l),a=>(e.openBlock(),e.createElementBlock("button",{key:`recent-${a.latitude}-${a.longitude}`,type:"button",class:"wx-city-chip",onClick:L=>de(a)},[e.createElementVNode("span",Kt,e.toDisplayString(a.name),1)],8,Jt))),128))])])):e.createCommentVNode("",!0),e.createElementVNode("div",Gt,[e.createElementVNode("h4",null,e.toDisplayString(e.unref(t.$t)("plugin.weather-widget.ui.popular_cities")),1),e.createElementVNode("div",Zt,[(e.openBlock(!0),e.createElementBlock(e.Fragment,null,e.renderList(e.unref(Qe),a=>(e.openBlock(),e.createElementBlock("button",{key:`popular-${a.latitude}-${a.longitude}`,type:"button",class:"wx-city-chip",onClick:L=>de(a)},[e.createElementVNode("span",en,e.toDisplayString(a.name),1)],8,vt))),128))])])])])):(e.openBlock(),e.createElementBlock("div",tn,[e.unref(V)&&!e.unref(s)?(e.openBlock(),e.createElementBlock("div",nn,[...i[8]||(i[8]=[e.createElementVNode("div",{class:"wx-skeleton wx-skeleton--lg"},null,-1),e.createElementVNode("div",{class:"wx-skeleton wx-skeleton--md"},null,-1),e.createElementVNode("div",{class:"wx-skeleton wx-skeleton--grid"},null,-1)])])):e.unref(j)&&!e.unref(s)?(e.openBlock(),e.createElementBlock("div",an,[e.createVNode(e.unref(t.IconifyIcon),{icon:"lucide:cloud-off",class:"size-10 opacity-65"}),e.createElementVNode("p",null,e.toDisplayString(e.unref(t.$t)("plugin.weather-widget.ui.error")),1),e.createElementVNode("button",{type:"button",class:"wx-action-btn",onClick:i[4]||(i[4]=(...a)=>e.unref(f)&&e.unref(f)(...a))},[e.createVNode(e.unref(t.IconifyIcon),{icon:"lucide:refresh-cw",class:"size-4"}),e.createTextVNode(" "+e.toDisplayString(e.unref(t.$t)("plugin.weather-widget.ui.retry")),1)])])):e.unref(s)?(e.openBlock(),e.createElementBlock(e.Fragment,{key:2},[e.createElementVNode("header",on,[e.createElementVNode("button",{type:"button",class:"wx-city-btn","aria-label":e.unref(t.$t)("plugin.weather-widget.ui.change_city"),onClick:i[5]||(i[5]=a=>I.value=!0)},[e.createVNode(e.unref(t.IconifyIcon),{icon:"lucide:map-pin",class:"size-3.5 opacity-70"}),e.createElementVNode("span",ln,e.toDisplayString(e.unref(r)),1),e.createVNode(e.unref(t.IconifyIcon),{icon:"lucide:chevron-down",class:"size-3.5 opacity-60"})],8,rn),e.createElementVNode("div",sn,[e.createElementVNode("span",cn,e.toDisplayString(Me.value),1),e.createElementVNode("button",{type:"button",class:"wx-icon-btn",disabled:e.unref(h),"aria-label":e.unref(t.$t)("plugin.weather-widget.ui.auto_locate"),onClick:i[6]||(i[6]=(...a)=>e.unref(x)&&e.unref(x)(...a))},[e.createVNode(e.unref(t.IconifyIcon),{icon:e.unref(h)?"lucide:loader-2":"lucide:locate",class:e.normalizeClass(e.unref(h)?"size-4 animate-spin":"size-4")},null,8,["icon","class"])],8,dn),e.createElementVNode("button",{type:"button",class:"wx-icon-btn",disabled:e.unref(D),"aria-label":e.unref(t.$t)("plugin.weather-widget.ui.refresh"),onClick:i[7]||(i[7]=(...a)=>e.unref(f)&&e.unref(f)(...a))},[e.createVNode(e.unref(t.IconifyIcon),{icon:e.unref(D)?"lucide:loader-2":"lucide:refresh-cw",class:e.normalizeClass(e.unref(D)?"size-4 animate-spin":"size-4")},null,8,["icon","class"])],8,pn)])]),i[9]||(i[9]=e.createElementVNode("div",{class:"wx-scene","aria-hidden":"true"},[e.createElementVNode("span",{class:"wx-scene__orb"}),e.createElementVNode("span",{class:"wx-scene__cloud wx-scene__cloud--1"}),e.createElementVNode("span",{class:"wx-scene__cloud wx-scene__cloud--2"}),e.createElementVNode("span",{class:"wx-scene__spark wx-scene__spark--1"}),e.createElementVNode("span",{class:"wx-scene__spark wx-scene__spark--2"}),e.createElementVNode("span",{class:"wx-scene__spark wx-scene__spark--3"}),e.createElementVNode("span",{class:"wx-scene__drop wx-scene__drop--1"}),e.createElementVNode("span",{class:"wx-scene__drop wx-scene__drop--2"}),e.createElementVNode("span",{class:"wx-scene__drop wx-scene__drop--3"}),e.createElementVNode("span",{class:"wx-scene__flake wx-scene__flake--1"}),e.createElementVNode("span",{class:"wx-scene__flake wx-scene__flake--2"}),e.createElementVNode("span",{class:"wx-scene__mist wx-scene__mist--1"}),e.createElementVNode("span",{class:"wx-scene__mist wx-scene__mist--2"}),e.createElementVNode("span",{class:"wx-scene__flash"})],-1)),e.createElementVNode("div",xn,[e.createElementVNode("div",wn,[e.createElementVNode("span",null,e.toDisplayString(Me.value),1),e.createElementVNode("span",null,e.toDisplayString(e.unref(t.$t)("plugin.weather-widget.ui.last_updated"))+" "+e.toDisplayString(Wn.value),1)]),e.createElementVNode("div",gn,[e.createElementVNode("div",fn,[e.createElementVNode("div",hn,e.toDisplayString(e.unref(k)(e.unref(s).temperature,e.unref(o)))+"° ",1),e.createElementVNode("div",un,e.toDisplayString(Ue(e.unref(s))),1),e.createElementVNode("div",mn,[e.createElementVNode("span",null,e.toDisplayString(e.unref(t.$t)("plugin.weather-widget.ui.feels_like"))+" "+e.toDisplayString(e.unref(k)(e.unref(s).apparent_temperature,e.unref(o)))+"°"+e.toDisplayString(Fe.value),1),K.value?(e.openBlock(),e.createElementBlock("span",_n,e.toDisplayString(e.unref(t.$t)("plugin.weather-widget.ui.high_short"))+" "+e.toDisplayString(e.unref(k)(K.value.temp_max,e.unref(o)))+"° / "+e.toDisplayString(e.unref(t.$t)("plugin.weather-widget.ui.low_short"))+" "+e.toDisplayString(e.unref(k)(K.value.temp_min,e.unref(o)))+"° ",1)):e.createCommentVNode("",!0)])]),e.createElementVNode("div",bn,[e.createElementVNode("div",yn,[e.createVNode(e.unref(t.IconifyIcon),{icon:`lucide:${ee(e.unref(s).weather_code,e.unref(s).is_day)}`,class:"wx-hero__icon"},null,8,["icon"])]),e.createElementVNode("span",kn,e.toDisplayString(Fe.value),1)])]),e.unref(q)?(e.openBlock(),e.createElementBlock("div",En,e.toDisplayString(e.unref(t.$t)("plugin.weather-widget.ui.data_stale")),1)):e.createCommentVNode("",!0)]),e.createElementVNode("section",Nn,[(e.openBlock(!0),e.createElementBlock(e.Fragment,null,e.renderList(Un.value,a=>(e.openBlock(),e.createElementBlock("article",{key:a.key,class:"wx-chip"},[e.createElementVNode("span",null,e.toDisplayString(a.label),1),e.createElementVNode("strong",{style:e.normalizeStyle(a.tone?{color:a.tone}:void 0)},e.toDisplayString(a.value),5),a.note?(e.openBlock(),e.createElementBlock("small",{key:0,style:e.normalizeStyle(a.tone?{color:a.tone}:void 0)},e.toDisplayString(a.note),5)):e.createCommentVNode("",!0)]))),128))]),qe.value.length>0?(e.openBlock(),e.createElementBlock("section",Vn,[e.createElementVNode("div",Cn,[e.createElementVNode("h4",null,e.toDisplayString(e.unref(t.$t)("plugin.weather-widget.ui.hourly_forecast")),1),e.createElementVNode("span",null,e.toDisplayString(e.unref(t.$t)("plugin.weather-widget.ui.hourly_digest")),1)]),e.createElementVNode("div",{ref_key:"hourlyScrollRef",ref:Le,class:"wx-hourly-scroll"},[(e.openBlock(!0),e.createElementBlock(e.Fragment,null,e.renderList(qe.value,(a,L)=>(e.openBlock(),e.createElementBlock("article",{key:`hour-${L}`,class:e.normalizeClass(["wx-hour-item",a.is_current?"wx-hour-item--active":""])},[e.createElementVNode("span",$n,e.toDisplayString(jn(a.time,a.is_current)),1),e.createVNode(e.unref(t.IconifyIcon),{icon:`lucide:${ee(a.weather_code,e.unref(s).is_day)}`,class:"size-4"},null,8,["icon"]),e.createElementVNode("span",zn,e.toDisplayString(e.unref(k)(a.temperature,e.unref(o)))+"° ",1)],2))),128))],512)])):e.createCommentVNode("",!0),e.createElementVNode("div",Bn,[e.createElementVNode("article",Dn,[e.createElementVNode("span",null,e.toDisplayString(e.unref(t.$t)("plugin.weather-widget.ui.sunrise")),1),e.createElementVNode("strong",null,e.toDisplayString(e.unref(Ee)((y=K.value)==null?void 0:y.sunrise)),1)]),e.createElementVNode("article",In,[e.createElementVNode("span",null,e.toDisplayString(e.unref(t.$t)("plugin.weather-widget.ui.sunset")),1),e.createElementVNode("strong",null,e.toDisplayString(e.unref(Ee)((T=K.value)==null?void 0:T.sunset)),1)])]),Re.value.length>0?(e.openBlock(),e.createElementBlock("section",Tn,[e.createElementVNode("div",Ln,[e.createElementVNode("h4",null,e.toDisplayString(e.unref(t.$t)("plugin.weather-widget.ui.forecast")),1),e.createElementVNode("span",null,e.toDisplayString(e.unref(t.$t)("plugin.weather-widget.ui.forecast_digest")),1)]),(e.openBlock(!0),e.createElementBlock(e.Fragment,null,e.renderList(Re.value,(a,L)=>(e.openBlock(),e.createElementBlock("article",{key:a.date,class:"wx-forecast-row"},[e.createElementVNode("div",An,[e.createElementVNode("span",null,e.toDisplayString(e.unref(Ce)(a.date,L,e.unref(t.$t))),1),e.createElementVNode("small",null,e.toDisplayString(Ue(a)),1)]),e.createVNode(e.unref(t.IconifyIcon),{icon:`lucide:${ee(a.weather_code,e.unref(s).is_day)}`,class:"size-4"},null,8,["icon"]),e.createElementVNode("div",Sn,[e.createElementVNode("span",null,e.toDisplayString(e.unref(t.$t)("plugin.weather-widget.ui.high_short"))+" "+e.toDisplayString(e.unref(k)(a.temp_max,e.unref(o)))+"° ",1),e.createElementVNode("span",null,e.toDisplayString(e.unref(t.$t)("plugin.weather-widget.ui.low_short"))+" "+e.toDisplayString(e.unref(k)(a.temp_min,e.unref(o)))+"° ",1)])]))),128))])):e.createCommentVNode("",!0)],64)):e.createCommentVNode("",!0)]))]}),_:1})],2)],4)):e.createCommentVNode("",!0)]))],64))}}),Ie={_meta:{lang:"zh"},ui:{temperature:"温度",feels_like:"体感温度",humidity:"湿度",wind_speed:"风速",uv_index:"紫外线",aqi:"空气质量",sunrise:"日出",sunset:"日落",hourly_forecast:"小时预报",hourly_digest:"未来几小时走势",forecast:"未来预报",forecast_digest:"接下来几天概览",current_conditions:"当前天气",current_city:"当前城市",last_updated:"更新于",live_data:"实时",cached_data:"缓存",change_city:"切换城市",search_city:"搜索城市...",recent_cities:"最近城市",popular_cities:"热门城市",auto_locate:"自动定位",locating:"定位中...",loading:"加载天气中...",error:"天气数据获取失败",retry:"重试",refresh:"刷新天气",open_weather:"打开天气面板",back:"返回",close:"关闭",today:"今天",tomorrow:"明天",day_after:"后天",now:"现在",weekday_0:"周日",weekday_1:"周一",weekday_2:"周二",weekday_3:"周三",weekday_4:"周四",weekday_5:"周五",weekday_6:"周六",data_stale:"数据可能已过期",high_short:"高",low_short:"低",unit_kmh:"公里/小时",unit_mph:"英里/小时"},error:{city_not_found:"未找到该城市",api_timeout:"天气服务请求超时",network:"网络错误，请稍后重试",locate_failed:"定位失败，请检查权限",locate_fallback:"无法识别城市，使用坐标定位"},aqi_level:{good:"优",moderate:"良",unhealthy_sensitive:"轻度",unhealthy:"中度",very_unhealthy:"重度",hazardous:"严重",na:"--"}},Te={_meta:{lang:"en"},ui:{temperature:"Temperature",feels_like:"Feels Like",humidity:"Humidity",wind_speed:"Wind",uv_index:"UV Index",aqi:"Air Quality",sunrise:"Sunrise",sunset:"Sunset",hourly_forecast:"Hourly",hourly_digest:"Next few hours",forecast:"Forecast",forecast_digest:"Upcoming days",current_conditions:"Current Conditions",current_city:"Current City",last_updated:"Updated",live_data:"Live",cached_data:"Cached",change_city:"Change City",search_city:"Search city...",recent_cities:"Recent Cities",popular_cities:"Popular Cities",auto_locate:"Auto Locate",locating:"Locating...",loading:"Loading weather...",error:"Failed to load weather data",retry:"Retry",refresh:"Refresh weather",open_weather:"Open weather panel",back:"Back",close:"Close",today:"Today",tomorrow:"Tomorrow",day_after:"Day After",now:"Now",weekday_0:"Sun",weekday_1:"Mon",weekday_2:"Tue",weekday_3:"Wed",weekday_4:"Thu",weekday_5:"Fri",weekday_6:"Sat",data_stale:"Data may be outdated",high_short:"H",low_short:"L",unit_kmh:"km/h",unit_mph:"mph"},error:{city_not_found:"City not found",api_timeout:"Weather service timed out",network:"Network error, please try again",locate_failed:"Location failed, check permissions",locate_fallback:"Could not identify city, using coordinates"},aqi_level:{good:"Good",moderate:"Moderate",unhealthy_sensitive:"Sensitive",unhealthy:"Unhealthy",very_unhealthy:"Very Unhealthy",hazardous:"Hazardous",na:"--"}},Rn=`
...
`;function qn(){const n=window.NovusPluginShared;if(n!=null&&n.registerLocale&&(n.registerLocale("zh-CN","plugin.weather-widget",Ie),n.registerLocale("zh","plugin.weather-widget",Ie),n.registerLocale("en-US","plugin.weather-widget",Te),n.registerLocale("en","plugin.weather-widget",Te)),!document.getElementById("wx-plugin-styles")){const r=document.createElement("style");r.id="wx-plugin-styles",r.textContent=Rn,document.head.appendChild(r)}}E.WeatherDashboardWidget=Vt,E.WeatherHeaderWidget=Fn,E.setup=qn,Object.defineProperty(E,Symbol.toStringTag,{value:"Module"})}));
