...
> **退役说明（2026-04）**：AI 表策略与 `data_intelligence` 技能链路已正式退役，相关 API、表与同步流程已删除。本文档仅作为历史审计快照，不应作为活跃功能的指导。
...
> **历史说明**：截至 2026-04，AI 表策略与 `data_intelligence` 能力已退役。上述结论仅供追溯历史改动，当前仓库已删除所有相关模型/API/同步代码，开发新功能请勿依赖该能力。
